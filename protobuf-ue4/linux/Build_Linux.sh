...
readonly UE4_LIBCXX_ROOT="${UE4_ROOT}/Engine/Source/ThirdParty/Unix/LibCxx"
readonly UE4_ZLIB_DIR="${UE4_ROOT}/Engine/Source/ThirdParty/zlib/${UE4_ZLIB_VERSION}/lib/Unix/x86_64-unknown-linux-gnu"
...
export LDFLAGS="-L${UE4_LIBCXX_ROOT}/lib/Unix/x86_64-unknown-linux-gnu \
  -L${UE4_ZLIB_DIR}                                                     \
